...
def get_relevant_docs(query: str, category_filter: str = None):
    """Cari relevan resume dari database Qdrant berdasarkan deskripsi posisi pekerjaan atau pertanyaan terkait jabatan kerja atau perbandingan antar dua posisi pekerjaan, dengan opsi category_filter. Wajib gunakan category_filter saat Anda mengidentifikasi KATEGORI/INDUSTRI dari pertanyaan pengguna (misalnya: 'HR', 'IT', 'SALES')."""
